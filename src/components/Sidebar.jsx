...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='relative flex-col hidden sm:hidden md:block lg:block xl:block lg:min-w-[300px] xl:min-w-[300px] border-r min-h-full p-4 bg-white rounded-[10px]'>
        ...
        <Link href={"/"}>
          <div className='gap-2 px-2 py-3 bg-gray-50 hover:bg-purple-200 rounded-lg my-3 p-2 grid  sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer'>
            <HomeIcon />
            <div className=''>
              Home
            </div>
