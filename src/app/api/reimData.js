const reimData = async () => {
    const supCode = 'a'; // This should be set to the actual value you want to test
    ...
    try {
        ...
        const queryParams = supCode ? `?supCode=${encodeURIComponent(supCode)}` : '';
        const url = `http://localhost:8000/reimbursementSummery${queryParams}`;
